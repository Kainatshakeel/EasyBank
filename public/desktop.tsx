...
const CustomIcon: React.FC<IconProps> = ({ width = 1271, height = 1034, className, fill = "#FFF" }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width={width} height={height} className={className} viewBox="0 0 1271 1034">
      <defs>
